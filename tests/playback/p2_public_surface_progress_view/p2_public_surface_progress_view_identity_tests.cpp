...
int main() {
    ...
    test_p2_public_surface_progress_view_anchor_default_construction();
    test_p2_public_surface_progress_view_classification_default_construction();
    test_p2_public_surface_progress_view_progress_view_default_construction();
    test_p2_public_surface_progress_view_outcome_default_construction();
    test_p2_public_surface_progress_view_boundary_cross_family();
    std::cout << "p2_public_surface_progress_view tests passed" << std::endl;
    return 0;
}
