...
int main() {
    ...
    test_p2_public_surface_commitment_view_anchor_default_construction();
    test_p2_public_surface_commitment_view_classification_default_construction();
    test_p2_public_surface_commitment_view_commitment_view_default_construction();
    test_p2_public_surface_commitment_view_outcome_default_construction();
    test_p2_public_surface_commitment_view_boundary_cross_family();
    std::cout << "p2_public_surface_commitment_view tests passed" << std::endl;
    return 0;
}
