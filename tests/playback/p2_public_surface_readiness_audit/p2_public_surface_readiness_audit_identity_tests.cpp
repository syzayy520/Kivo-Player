...
int main() {
    ...
    test_p2_public_surface_readiness_audit_anchor_default_construction();
    test_p2_public_surface_readiness_audit_classification_default_construction();
    test_p2_public_surface_readiness_audit_audit_default_construction();
    test_p2_public_surface_readiness_audit_outcome_default_construction();
    test_p2_public_surface_readiness_audit_boundary_cross_family();
    std::cout << "p2_public_surface_readiness_audit tests passed" << std::endl;
    return 0;
}
